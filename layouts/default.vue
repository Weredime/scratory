<template>
  <div class="scratory-page">
    <div
      ref="banner"
      class="banner bg-green-500 w-full p-5 text-white font-bold"
      v-if="isClient && !$settings.get('accepted')"
    >
      <div class="grid grid-cols-4">
        <div class="col col-span-3">
          <span
            >We use localStorage.<br />to customize your experience (power the
            settings)</span
          >
          <br />
          <span
            >If you don't like us using localStorage on your computer, just
            leave this site plz</span
          >
        </div>
        <div class="col">
          <button
    ...
    <div class="footer p-10 flex justify-center">
      <div class="grid grid-cols-2 sm:grid-cols-3 w-full">
        <div class="col">
          ...
          <p>
            <a href="https://scratch.mit.edu/users/9gr">@9gr</a> for making
            scratory
          </p>
          <p>
            <a href="https://scratch.mit.edu/users/DatOneLefty">@DatOneLefty</a>
            for <a href="https://scratchdb.lefty.one">ScratchDB</a>
          </p>
          <p>
            <a href="https://scratch.mit.edu/users/Jeffalo">@Jeffalo</a> for
            ocular statuses
          </p>
          <p>
        ...
        <div class="col hidden sm:block">
          ...
          <a href="https://github.com/FunctionalMetatable/scratory"
...
export default {
  data() {
    return { isClient: process.client };
  },
  methods: {
    acceptCookies() {
